...
const ModalEdit = ({ data, show, setShow, setInfo }) => {
            ...
            <Modal size='5xl' show={show} onClose={() => setShow(false)}>
                ...
                <Modal.Body>
                    <div className="w-full p-2 flex flex-wrap items-center">
                        ...
                        <input type="text" id="first_name" class="bg-white border-[1px] border-[rgba(0,0,0,0.5)] text-gray-900 text-sm rounded-lg block w-1/2 p-2.5 shadow-[4px_4px_4px_rgba(0,0,0,0.25)]" placeholder={data?.name} required />
                    ...
                    <div className="w-full flex flex-wrap">
                        <div className="w-1/2 p-2 flex items-center">
                            ...
                            {/* <audio src={data ? data : ""} controls /> */}
                            <input type="text" id="first_name" disabled={isCheck ? true : false} className={`bg-white border-[1px] border-[rgba(0,0,0,0.5)] text-gray-900 text-sm rounded-lg block w-2/3 p-2.5 shadow-[4px_4px_4px_rgba(0,0,0,0.25)] ${isCheck && "opacity-50 cursor-no-drop"}`} placeholder={data?.point} required />
                        </div>

                        <div className="w-1/2  p-2 flex items-center">
                            <span className="pr-4">Tỷ trọng:</span>
                            {/* <audio src={data ? data : ""} controls /> */}
                            <input type="text" id="first_name" disabled={isCheck ? true : false} className={`bg-white border-[1px] border-[rgba(0,0,0,0.5)] text-gray-900 text-sm rounded-lg block w-2/3 p-2.5 shadow-[4px_4px_4px_rgba(0,0,0,0.25)] ${isCheck && "opacity-50 cursor-no-drop"}`} placeholder={data?.ratio} required />
                        </div>
                    </div>
                    ...
                    <div className="w-full flex flex-wrap">
                        <div className="w-1/2 p-2 flex items-center">
                            ...
                            {/* <audio src={data ? data : ""} controls /> */}
                            <input type="text" id="first_name" class="bg-white border-[1px] border-[rgba(0,0,0,0.5)] text-gray-900 text-sm rounded-lg block w-2/3 p-2.5 shadow-[4px_4px_4px_rgba(0,0,0,0.25)]" placeholder={data?.reviewPer} required />
                        </div>
                    ...
                    <div className="w-1/2 p-2 flex items-center">
                        ...
                        <Dropdown options={options2} value={options2[0]} placeholder="Chọn nhóm đối tượng..." />
                    </div>
